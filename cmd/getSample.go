...
var getSampleCmd = &cobra.Command{
	...
	Long: `getSample will default to returning samples in a zip named samples.zip, but it 
can also return the samples in raw given the "-r" flag. 

Example usage:
	- malpedia_cli getSample 12f38f9be4df1909a1370d77588b74c60b25f65a098a08cf81389c97d3352f82 -o samples1234.zip
